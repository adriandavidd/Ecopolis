  ...
  return (
    <div className="mx-20">
      <div className="flex flex-col items-center justify-center my-10 ">
        ...
        <p className="text-xl font-bold my-2">1. Fase de Planeación:</p>
        <p className="my-4 text-lg">
          <p className="text-lg font-bold my-4">Objetivo General:</p>
          ...
          Políticas y Económicas y Educación Artística para proponer soluciones
          a problemas urbanos reales.
        </p>
        <p className="text-lg font-bold mt-9">
        ...
        <div className="flex flex-col">
          <p className="my-4 text-lg mt-10">
            <strong>Metodología:</strong>
            <ul className="list-disc ">
              <li>
                Aprendizaje Basado en Proyectos (ABP): Los estudiantes
                trabajarán en equipos interdisciplinarios.
              </li>
              <li>
                Investigación Acción: Los estudiantes investigarán problemas
                reales y aplicarán sus conocimientos para proponer soluciones.
              </li>
              <li>
                Trabajo Colaborativo: Fomentar la colaboración entre estudiantes
                de diferentes disciplinas para integrar sus conocimientos.
              </li>
            </ul>
          </p>
          <p className="my-4 text-lg mt-10">
            ...
            <ul className="list-disc ">
              <li>Laboratorio de Química y materiales para experimentos.</li>
              <li>Calculadoras gráficas y software de modelado matemático.</li>
              <li>Recursos bibliográficos y bases de datos económicas.</li>
              <li>
                Materiales de dibujo técnico y software de diseño asistido por
                computadora (CAD).
              </li>
            </ul>
          </p>
          <p className="my-4 text-lg mt-10">
            ...
            <ul className="list-disc ">
              <li>Química: Experimentos y análisis de materiales.</li>
              <li>Cálculo: Modelos matemáticos y optimización.</li>
              <li>
                Ciencias Políticas y Económicas: Análisis económico y políticas
                públicas.
              </li>
              <li>
                Educación Artística: Diseño y presentación de planos y maquetas.
              </li>
            </ul>
          </p>
          <p className="my-4 text-lg mt-10">
            ...
            <ul className="list-disc ">
              <li>
                Evaluación continua a través de reportes y presentaciones
                parciales.
              </li>
              <li>
                Evaluación final del proyecto basado en el producto integrado y
                su presentación.
              </li>
            </ul>
          </p>
          <p className="text-xl font-bold mt-10 ">Cronograma:</p>
          <p className="my-4 text-lg">
            <ul className="list-disc ">
              <li>Semana 1-my-4: Introducción y formación de equipos.</li>
              <li>Semana 3-5: Investigación y análisis inicial.</li>
              <li>Semana 6-8: Desarrollo de propuestas y experimentos.</li>
              <li>Semana 9-11: Integración de resultados y diseño final.</li>
              <li>Semana 12: Presentación y evaluación del proyecto final.</li>
            </ul>
          </p>
        </div>

        <p className="text-xl font-bold my-4 mt-11">
          5. Fase de Presentación y Evaluación:
        </p>
        <p className="my-4 text-lg">
          <strong>Presentación:</strong> Cada equipo presentará su proyecto a la
        ...
        <p className="my-4 text-lg">
          ...
          estudiantes para enfrentar desafíos complejos de manera
          interdisciplinaria.
        </p>
      </div>
    </div>
