  ...
  return (
    <div className="mx-8 bg-white text-zinc-700 h-full">
      <div className="flex flex-col items-center">
        ...
        <p className="text-2xl font-bold mt-4 mb-2 ">1. Fase de Planeación:</p>
        <p className="my-4 text-xl px-5">
          <p className="text-2xl font-bold">Objetivo General:</p>Desarrollar un
        ...
        <div className="flex flex-col">
          ...
          <p className="text-2xl font-bold mt-8 mb-2">Cronograma:</p>
          <p className="my-4 text-xl">
            <ul className="list-disc">
              <li>Semana 1-2: Introducción y formación de equipos.</li>
